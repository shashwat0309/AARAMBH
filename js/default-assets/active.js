(function ($) {
    ...
    var countDownDate = new Date("sep 19, 2020 09:00:00").getTime();
    ...
    var x = setInterval(function() {
        ...
        if ($.fn.countdown) {
            $("#clock").countdown("2020/11/23", function (event) {
                $(this).html(event.strftime("<div>"+days+"<span>Days</span></div> <div>"+hours+"<span>Hours</span></div> <div>%m <span>Minutes</span></div> <div>%S <span>Seconds</span></div>"));
            });
        }
